...
linear = make_pipeline(RobustScaler(), LinearRegression()) # <--- Added Baseline
...
# %%
# --- Visualization: Feature Importance (XGBoost) ---
...
# We use the XGBoost model which is usually a good proxy for the ensemble's logic
...
plt.title("Top 20 Features Driving House Prices (XGBoost)", fontsize=16)
