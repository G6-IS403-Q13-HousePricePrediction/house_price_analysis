...
# %%
y_linear = np.exp(lr.predict(df_test_preprocess))

df_y_linear_out = test_df[['Id']]
df_y_linear_out['SalePrice'] = y_linear
df_y_linear_out.to_csv(SUBMISSIONS_DIR + 'linear_regression.csv', index=False)
